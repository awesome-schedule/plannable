      ...
      <div class="row">
        ...
        <div class="col">
          ...
          <div data-spy="scroll" data-target="#navbar-example3" data-offset="10">
            ...
            <p>
              ICalendar is a standard file which you can import to your Apple/Google Calendar. This website allows you to download the ICalendar to your
              computer after you have creatd your schedule. Then, you can go to your Apple/Google Calendar and then syncronize your schedule. Instruction is shown below:
            </p>
            ...
            <div class="bd-example">
              <div id="googleCalendarInstruction" class="carousel slide" data-ride="carousel">
                <ol class="carousel-indicators">
                  <li data-target="#googleCalendarInstruction" data-slide-to="0" class="active"></li>
                ...
                <div class="carousel-inner text-center">
                  ...
                  <div class="carousel-item">
                    ...
                    <h5>9. Now You Can View Your Schedule On Google Calendar!</h5>
                  </div>
                </div>
                <a
                  class="carousel-control-prev"
