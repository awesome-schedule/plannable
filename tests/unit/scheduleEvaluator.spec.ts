...
const schedules: RawAlgoSchedule = [
    ['1', [1], [8, 11, 11, 11, 11, 11, 11, 11, 100, 200, -1], [d1, d2]],
    ['2', [1], [8, 11, 11, 11, 11, 11, 11, 11, 50, 80, -1], [d1, d2]],
    ['3', [1], [8, 11, 11, 11, 11, 11, 11, 11, 350, 450, -1], [d1, d2]],
    ['4', [1], [8, 11, 11, 11, 11, 11, 11, 11, 10, 15, -1], [d1, d2]],
    ['5', [1], [8, 8, 14, 11, 11, 11, 11, 11, 500, 600, -1, 300, 350, -1], [d1, d2]],
    ['6', [1], [8, 8, 14, 11, 11, 11, 11, 11, 250, 300, -1, 100, 200, -1], [d1, d2]]
];
...
describe('Schedule Evaluator Test', () => {
    ...
    it('Insertion Test', () => {
        ...
        expect(s.blocks.slice(8, 20)).toEqual([10, 15, -1, 50, 80, -1, 100, 200, -1, 350, 450, -1]);
        expect(s.blocks.slice(20)).toEqual([
            100,
            200,
            -1,
            250,
